...
int OPTIMIZER::Genome_Age(int layerIndex, int genomeIndex) {
	...
	int age		 = genomesEvaluated - evalsCreated;
	    ...
	    age		 = 1 + int( (float) floor((float)age) );
...
// TBD: get rid of this extra fitness-only save
//	char fileName[100];
...
//		sprintf(fit,"%4.4f\n",genomes[i]->fitness);// TBD: this too
//		fitFile << fit;// TBD: and this
	}
//	fitFile << "\n";// TBD: and this
//	fitFile.close();// TBD: and this
}
