...
void Simulate(int pause) {
	...
	if ( !pause ) {
		...
		// TBD: read the playback script here
...
// TBD: not right; need to check for the last v (or edit the script to end at
// the last v, then check for EOF). 
...
// TBD: need the following for script playback 
...
// TBD:  when playing back a script, remove next line
