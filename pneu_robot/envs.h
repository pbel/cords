...
public:
	...
	void Mode_Simulate_Set_File(void);
	...
	void Show_Champ(	dWorldID      world, 
				dSpaceID      space);
	void Show_From_File(	dWorldID      world, 
				dSpaceID      space,
				char*	      fileName);
...
private:
	...
	void Create_Robot_To_Evaluate(	dWorldID      world, 
					dSpaceID      space);
	void Create_Robot_From_Controller_File(	dWorldID      world, 
						dSpaceID      space,
						char*	      fileName);
