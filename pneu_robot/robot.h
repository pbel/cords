...
public:
	...
	int		  botType; // for hard-coded robots 
...
public:
	...
	int  Get_Num_Motor_Groups(void);
	int  Get_Num_Time_Steps(void);
...
private:
	...
	void Actuate_Motors(int timeSeqNum);
	void Component_Reindex_After_Deletion(void);
	void Connect_Joint(void);
	void Create_Pneu_Quad(void);
	void Create_Pneu_Quad_Joints(void);
	void Create_Pneu_Quad_Objects(void);
